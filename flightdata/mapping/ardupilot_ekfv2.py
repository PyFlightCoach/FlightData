...
mapped_field_args = [
    ...
    (Fields.POSITION, 0, "NKF1PN", ureg.meter),
    (Fields.POSITION, 1, "NKF1PE", ureg.meter),
    (Fields.POSITION, 2, "NKF1PD", ureg.meter),
    ...
    (Fields.QUATERNION, 0, "NKQ1Q1", 1),
    (Fields.QUATERNION, 1, "NKQ1Q2", 1),
    (Fields.QUATERNION, 2, "NKQ1Q3", 1),
    (Fields.QUATERNION, 3, "NKQ1Q4", 1),
    (Fields.QUATERNION, 3, "NKQ1Q4", 1),
